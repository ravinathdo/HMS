            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <table>
                        <tr>
                            <td>Doctor Fee</td>
                            <td><h3><?= $this->session->userdata('doctorPayment')->doc_fee ?></h3></td>
                        </tr>
                        <tr>
                            <td>Hospital Fee</td>
                            <td><h3><?= $this->session->userdata('doctorPayment')->hospital_fee ?></h3></td>
                        </tr>
                        <tr>
                            <td>Total Fee</td>
                            <td><h2><?= $this->session->userdata('doctorPayment')->total_fee ?></h2></td>
                        </tr>
                        <tr>
