            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <a href="<?php echo base_url('Pharmacist_Controller/loadManageDrug'); ?>">
                        <img src="<?= base_url('/images/icon-drug.png') ?>" alt="..." class="img-thumbnail" title="Manage Drug">
                    </a>
                    <a href="<?php echo base_url('Pharmacist_Controller/loadViewStock'); ?>">
                        <img src="<?= base_url('/images/icon-stock.png') ?>" alt="..." class="img-thumbnail" title="View Stock">
                    </a>
                </div>
            </div>
        </div>
