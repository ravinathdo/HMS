...
insert  into `hms_vehicle_request`(`id`,`request_by`,`comment`,`status_code`,`vehicle_id`,`created_time`,`created_user`) values (1,8,'plz get the ambulance','PENDING',NULL,'2018-08-28 23:10:14',8);
